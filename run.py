...
def main():
    ...
    # output folder is by default same as input scan adding "./<scan_name>_SALSA.nii.gz"
    parser.add_argument("--model_dir", default = "./src/model/model_weights/", help = "Path to nnU-Net model directory")
    ...
    parser.add_argument("--recist", default = True, help = "True or False: turn to False if you do not want to apply post-processing based on RECIST-criteria")
