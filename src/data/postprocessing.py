...
def recist_labeling(path_scan: str, vol_thr_mm3 = 523.6):
    ...
    print(f"Out of the {num_labels} predicted: {n_large} are measurable by RECIST criteria {n_small} are considered non-measurable disease")
